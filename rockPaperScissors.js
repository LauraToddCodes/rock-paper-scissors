    ...
    if (x.matches) {
        ...
        $("img.optionImg").on("click", function() {
            ...
            if (oppResult == 1) {
                ...
                .delay(0)
                .queue(function (next) {
                    $(this).attr("src", "https://lauratoddcodes.github.io/rock-paper-scissors/images/rockOpp.png")
                    .css({
                        "width":"100px",
                        "margin": "0 5px"
                    })
                ...
                .delay(0)
                .queue(function (next) {
                    $(this).attr("src", "https://lauratoddcodes.github.io/rock-paper-scissors/images/paperOpp.png")
                    .css({
                        "width":"100px",
                        "margin": "0 5px"
                    })
                ...
                .delay(0)
                .queue(function (next) {
                    $(this).attr("src", "https://lauratoddcodes.github.io/rock-paper-scissors/images/scissorsOpp.png")
                    .css({
                        "width": "100px",
                        "margin": "0 5px"
                    });
        ...
        $("button#resetBtn").on("click", function() {
            ...
            $("img.opponentsImg").attr("src", "https://lauratoddcodes.github.io/rock-paper-scissors/images/question.png")
