    ...
    if (x.matches) {
        ...
        $("img.optionImg").on("click", function() {
            ...
            if (oppResult == 1) {
                ...
                .delay(0)
                .queue(function (next) {
                    $(this).attr("src", "http://www.lauratodddesign.com/codepen/rockOpp.png")
                    .css({
                        "width":"100px",
                        "margin": "0 5px"
                    })
                ...
                .delay(0)
                .queue(function (next) {
                    $(this).attr("src", "http://www.lauratodddesign.com/codepen/paperOpp.png")
                    .css({
                        "width":"100px",
                        "margin": "0 5px"
                    })
                ...
                .delay(0)
                .queue(function (next) {
                    $(this).attr("src", "http://www.lauratodddesign.com/codepen/scissorsOpp.png")
                    .css({
                        "width": "100px",
                        "margin": "0 5px"
                    });
        ...
        $("button#resetBtn").on("click", function() {
            ...
            $("img.opponentsImg").attr("src", "http://www.lauratodddesign.com/codepen/question.png")
